# Milestones: Pokémon Legends: Arceus

This roadmap governs research, tooling, analysis, reconstruction, and preservation for `SakuraiTsubaki/PokemonLegends-Arceus-Decompilation`.
...
Reuse proven Nintendo Switch methods while maintaining an independent title-specific architecture and data map.
